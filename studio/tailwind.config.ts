  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        'progress-circle': {
          '0%': { 'stroke-dashoffset': '282.743338823' },
        },
        spin: {
        ...
        'glow-pulse': {
          '0%, 100%': { boxShadow: '0 0 12px rgba(59,130,246,0.3), 0 0 32px rgba(59,130,246,0.1)' },
          '50%': { boxShadow: '0 0 24px rgba(59,130,246,0.5), 0 0 64px rgba(59,130,246,0.2)' },
        },
        shimmer: {
      ...
      animation: {
        ...
        'progress-circle': 'progress-circle 1s ease-out forwards',
        ...
        'scan-sweep': 'scan-sweep 4.8s cubic-bezier(0.45, 0, 0.55, 1) infinite',
      },
    },
  },
