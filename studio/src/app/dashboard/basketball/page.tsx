...
import { Dribbble, ArrowLeft, Lock } from "lucide-react";
...
/**
 * Placeholder route. The basketball module is built but not released yet, so this
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardContent className="flex flex-col items-center justify-center gap-4 py-20 text-center">
          ...
          <h1 className="text-2xl font-bold tracking-tight">{t('basketballModuleTitle')}</h1>
