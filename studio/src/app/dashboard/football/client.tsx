...
import { collection, addDoc, query, where, orderBy, onSnapshot, Timestamp, deleteDoc, updateDoc, doc, serverTimestamp } from "firebase/firestore";
                                            ...
                                            <Card key={match.id} className={cn("overflow-hidden hover:border-primary/50 transition-colors group", resultClasses.bg)}>
                                                ...
                                                <CardContent className="p-4">
                                                    ...
                                                    <div className="mt-4 flex justify-around text-center border-t border-border/20 pt-3">
                                                        ...
                                                        <div className="text-foreground"><p className="font-bold text-xl">{match.stamina}/10</p><p className="text-xs text-muted-foreground">{'Stamina'}</p></div>
                                                    </div>
